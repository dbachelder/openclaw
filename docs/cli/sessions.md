...
| `--active-key <key>` | Protect a specific active key from age, count, and disk-budget eviction. Inactive group and thread-scoped chat sessions remain eligible for maintenance.                                                                                                                                            |
